          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
                ...
                <h3 className="text-lg font-bold text-gray-900 mb-3">Lernplattformen</h3>
                <p className="text-gray-600 text-sm">
                  Implementierung von LMS und digitalen Lernumgebungen
                </p>
              </div>
              <div className="bg-white p-6 rounded-2xl shadow-lg text-center">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Umfassende Fortbildungen für alle Beteiligten und Begleitung des Veränderungsprozesses.</p>
                </div>
              </div>
              <div className="flex items-start space-x-6">
