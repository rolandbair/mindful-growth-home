    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Empowering schools through inclusive leadership, digitalization, and organizational excellence.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="#" className="hover:text-white transition-colors">Inclusive Leadership</a></li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p>Email: hello@edutransform.com</p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 EduTransform. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
