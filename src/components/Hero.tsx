        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                We empower schools with inclusive leadership, cutting-edge digitalization, 
                and strategic organizational development to create thriving learning environments.
              </p>
            </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-2xl shadow-xl">
              <div className="text-sm text-gray-600">Digital Innovation</div>
